...
namespace Lab6
{
    public class Program
    {
        ...
        public static async Task<Weather> GetRandomWeather()
        {
            ...
            var prev_culture = Thread.CurrentThread.CurrentCulture;
        ...
        public static async Task Main()
        {
            ...
            Weather weather_clear_sky = weathers.Find(x => x.Description.Equals("clear sky"));
            Weather weather_rain = weathers.Find(x => x.Description.Equals("rain"));
            Weather weather_few_clouds = weathers.Find(x => x.Description.Equals("few clouds"));
            ...
            Console.WriteLine($"""
                ...
                Country, name with clear sky : {weather_clear_sky.Country}, {weather_clear_sky.Name},
                Country, name with rain : {weather_rain.Country}, {weather_rain.Name},
                Country, name with few clouds : {weather_few_clouds.Country}, {weather_few_clouds.Name},
                """);
